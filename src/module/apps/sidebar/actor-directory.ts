import { ActorExitNihilo } from "@actor";
import { htmlQueryAll } from "@util/dom";

/** Extend ActorDirectory to show more information */
export class ActorDirectoryExitNihilo<TDocument extends ActorExitNihilo> extends ActorDirectory<TDocument> {
    ...
    override async getData(): Promise<object> {
        return {
            ...(await super.getData()),
            documentPartial: "systems/exit-nihilo/templates/sidebar/actor-document-partial.hbs",
        };
    }
